...
<html>
<head>
    <title>MAX BMW Motorcycles - Register for new account</title>
...
<div id="centered">
    <uc:UC_MainMenu runat="server" />
                       <input type="hidden" runat="server" id="hiddenSessionValue" value="" />
        ...
        <tr>
            <td style="vertical-align: top;" align="center">                            
                <form id="USERFORM" action="UserRegister.aspx" method="post">
                        ...
                        <tr>
                            <td align="left" class="Content">
                                <table cellspacing="0" cellpadding="1" border="0">   			  									  
                                    ...
                                    <tr>
                                        <td><input name="EMAIL" id="EMAIL" value="<%=m_eMail %>" type="text" maxlength="60" style="width:230px;" /><span class="RequiredField">*</span></td>
                                        <td>&nbsp;&nbsp;<input name="EMAIL2" id="EMAIL2" value="<%=m_eMail %>" type="text" maxlength="60" style="width:230px;" /><span class="RequiredField">*</span></td>                                                       
                                    </tr>
                                    <%=m_MsgEmail %>
                                    <tr>
                                        <td colspan="2">&nbsp;</td>                                                       
                                    ...
                                    <tr>
                                        <td colspan="2" style="color: #666; font-size: 11px; font-weight: normal;">Password is case sensitive. 6 characters minimum length.</td>                                                       
                                    </tr>
                                    <tr>
                                        <td colspan="2">&nbsp;</td>
                                    </tr>
                        ...
                        <tr>
                            <td align="left" class="Content">
                                <table cellspacing="0" cellpadding="2" border="0">
                                    <tr>
                                        <td>
                                            <input name="SIGNUP" id="SIGNUP" type="checkbox" style="border: 0px; background-color: #fff;" />Signup to our e-mail Newsletter                                                        
                                        </td>
                                    </tr>
                                </table>
                                <br />  
                    ...
                    <script type="text/javascript" src="https://www.google.com/recaptcha/api/challenge?k=6LdcjAgAAAAAAGQxRUUdMlFRgadJcIaqjZbBqrb8"></script>
                    <noscript>        
                        <iframe src="https://www.google.com/recaptcha/api/noscript?k=6LdcjAgAAAAAAGQxRUUdMlFRgadJcIaqjZbBqrb8" height="300" width="500" frameborder="0"></iframe><br>
                    ...
                    <br />
                      <table cellspacing="0" cellpadding="1" border="0">
                          <tr>
                              <td></td>
                              <td> <img src="CaptchaCode.aspx" alt="CAPTCHA" /></td>
                          </tr>
                            <tr>
                                <td> <label for="captcha">Enter CAPTCHA :</label></td>
                                <td><input type="text" runat="server" id="captcha" name="captcha" /><span class="RequiredField">*</span></td></td>
                            </tr>
                        
                     </table>
                    <br />
                    <span class="Button" onclick="if (ValidateFields()) document.getElementById('USERFORM').submit();">&nbsp;&nbsp;Create Account&nbsp;&nbsp;</span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
